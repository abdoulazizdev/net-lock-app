...
export default function SettingsScreen() {
  ...
  const handleImport = () => {
    Alert.alert("Import de données", "Collez le JSON exporté précédemment", [
      { text: "Annuler", style: "cancel" },
      {
        ...
        onPress: () => {
          Alert.alert(
            "Info",
            "Fonctionnalité à implémenter avec un sélecteur de fichier",
          );
        },
      },
    ]);
      ...
      <List.Section>
        ...
        <List.Item
          ...
          left={(props) => (
            <List.Icon
              {...props}
              icon={vpnStatus.isActive ? "shield-check" : "shield-off"}
            />
          )}
        />
